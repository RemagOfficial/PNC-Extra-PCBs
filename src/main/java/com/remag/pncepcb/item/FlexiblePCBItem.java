...
public class FlexiblePCBItem extends EmptyPCBItem {
    ...
    public boolean onEntityItemUpdate(ItemStack stack, ItemEntity entityItem) {
        ...
        if (entityItem.level().getFluidState(entityItem.blockPosition()).getType().is(PneumaticCraftTags.Fluids.ETCHING_ACID)) {
            ...
            if (etchProgress < 100) {
                ...
                ItemStack successStack = new ItemStack(successCount == 0 ? ModItems.FLEXIBLE_FAILED_PCB.get() : ModItems.FLEXIBLE_UNASSEMBLED_PCB.get(),
                ...
                if (successCount > 0 && failedCount > 0) {
                    ItemStack failedStack = new ItemStack(ModItems.FLEXIBLE_FAILED_PCB.get(), failedCount);
