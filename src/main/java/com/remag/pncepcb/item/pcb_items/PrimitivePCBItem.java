...
public class PrimitivePCBItem extends EmptyPCBItem {
    ...
    public boolean onEntityItemUpdate(ItemStack stack, ItemEntity entityItem) {
        ...
        if (entityItem.level().getFluidState(entityItem.blockPosition()).getType().is(PneumaticCraftTags.Fluids.ETCHING_ACID)) {
            ...
            if (etchProgress < 100) {
                ...
                ItemStack successStack = new ItemStack(successCount == 0 ? ModItems.PRIMITIVE_FAILED_PCB.get() : ModItems.PRIMITIVE_UNASSEMBLED_PCB.get(),
                ...
                if (successCount > 0 && failedCount > 0) {
                    ItemStack failedStack = new ItemStack(ModItems.PRIMITIVE_FAILED_PCB.get(), failedCount);
    ...
    public ItemStack getSuccessItem() {
        return new ItemStack(ModItems.PRIMITIVE_UNASSEMBLED_PCB.get());
    }

    public ItemStack getFailedItem() {
        return new ItemStack(ModItems.PRIMITIVE_FAILED_PCB.get());
    }
}
